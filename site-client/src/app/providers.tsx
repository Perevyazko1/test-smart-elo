                    ...
                    <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full">
                        <div className="pointer-events-auto relative w-screen max-w-md">
                            ...
                            <div
                                id={'modal-content'}
                                className={cn(
                                    'flex h-full flex-col bg-white py-20 shadow-sm relative thinYScroll transition-all',
                                    {
                                        'active': showContent,
                                        '': !showContent,
                                    }
                            ...
                            >
                                <div
                                    className={'flex justify-between gap-60 flex-nowrap align-items-center mb-50 pl-40 pr-15'}>
                                    ...
                                    <button onClick={closeNoConfirm}
                                            type={"button"}
                                            className={"cursor-pointer z-[80] p-15"}
                                    >
                                        <AppIcon icon={ICONS.CLOSE} className={'h-20 w-20'}/>
                                    </button>
                                </div>

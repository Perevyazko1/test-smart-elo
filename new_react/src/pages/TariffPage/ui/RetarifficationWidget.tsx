...
export const RetarifficationWidget = (props: RetarifficationWidgetProps) => {
    const {card} = props;
    ...
    const getSortIcon = useCallback((order_mode: 'ascending' | 'descending' | null) => {
        if (isFetching) {
            return (
        ...
        <div>
            ...
            {isLoading
                ...
                data && data.length > 0 ?
                    ...
                    :
                    <h5 className={'my-4'}>Хвостов в рамках тарификации нет</h5>
            }

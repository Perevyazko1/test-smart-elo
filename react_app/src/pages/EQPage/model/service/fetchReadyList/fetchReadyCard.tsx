...
interface fetchReadyCardProps {
    id: number,
}


export const fetchReadyCard = createAsyncThunk<order_product, fetchReadyCardProps, ThunkConfig<string>>(
    'eq/fetchReadyCard',
    async (params: fetchReadyCardProps, thunkAPI) => {
        ...
        try {
            const target_url = `/core/get_ready_list/${params.id}/`

...
export const fetchInWorkList = createAsyncThunk<order_product_list, fetchInWorkListProps, ThunkConfig<string>>(
    'eq/fetchInWorkList',
    async (params: fetchInWorkListProps, thunkAPI) => {
        ...
        try {
            const response = await extra.api.get<order_product_list>('/core/get_in_work_list/', {
                params: {
